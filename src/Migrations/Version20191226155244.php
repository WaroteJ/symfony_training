 ...
 */
final class Version20191226155244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE todolist CHANGE id_user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE todolist CHANGE user_id id_user_id INT NOT NULL');
